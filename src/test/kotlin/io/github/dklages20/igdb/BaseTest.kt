...
val igdbClassToDataLocation: Map<KClass<*>, String> = mapOf(
    ...
    GameMode::class to "$IGDB_RESOURCE_BASE_PATH/game_modes",
    ...
    Keyword::class to "$IGDB_RESOURCE_BASE_PATH/keywords",
    Language::class to "$IGDB_RESOURCE_BASE_PATH/languages",
    LanguageSupport::class to "$IGDB_RESOURCE_BASE_PATH/language_supports",
    LanguageSupportType::class to "$IGDB_RESOURCE_BASE_PATH/language_support_types",
